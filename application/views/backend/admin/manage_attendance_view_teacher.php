<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <?php echo form_open(site_url('admin/attendance_selector_teacher/')); ?>
        <div class="row">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <center>
                 ...
                 <?php echo form_open(site_url('admin/attendance_update_teacher/'. $class_id . '/' . $section_id . '/' . $timestamp)); ?>
                        ...
                        <tbody>
                            ...
                            foreach ($attendance_of_teachers as $row):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $this->db->get_where('teacher', array('teacher_id' => $row['teacher_id']))->row()->teacher_id; ?>
                                    </td>
                                    <td>
