<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'teacher_bulk_add') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/teacher_bulk_add'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('teacher_bulk_add'); ?></span>
                    </a>
                </li>
        ...
        <li>
            <a href="<?php echo site_url('admin/manage_attendance_teacher'); ?>">
                <span><i class="flaticon-clipboard"></i><?php echo get_phrase('daily_atendance_of_teacher'); ?></span>
            </a>
        </li>
