                            ...
                            <div class="panel-body table-responsive">
                                <div class="box-tools m-b-15">
                                    <div class="input-group">
                                        ...
                                        <div class="modal fade" id="addToBatch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    ...
                                                    <form class="form-horizontal" role="form" action="add_student_to_batch.php" method="POST">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <input class="form-control" name="id" placeholder="Enter Batch ID" />
                                                                </div>
                                            ...
                                            <form class="form-horizontal" role="form" action="add_student.php" method="POST">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" name="contact" placeholder="Contact no." />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
