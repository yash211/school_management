...
<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open(site_url('teacher/class_routine/do_update/'.$row['class_routine_id'])  , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
...
<script type="text/javascript">
    function section_subject_select(class_id , class_routine_id) {
        $.ajax({
            url: '<?php echo site_url('teacher/section_subject_edit/');?>' + class_id + '/' + class_routine_id ,
