<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'parent') echo 'active'; ?> ">
            <a href="<?php echo site_url('teacher/parent'); ?>">
        ...
        <li class="<?php if (
            ...
            <ul>
                <li class="<?php if ($page_name == 'class_routine_add') echo 'active'; ?> ">
                    <a href="<?php echo site_url($account_type . '/class_routine_add/' . $row['class_id']); ?>">
                ...
                ?>
                    <li class="<?php if ($page_name == 'class_routine' && $class_id == $row['class_id']) echo 'active'; ?>">
                        <a href="<?php echo site_url('teacher/class_routine/'); ?>">
                            <span><?php echo get_phrase('class'); ?><?php echo $row['name']; ?></span>
                        </a>
                    </li>
                <?php endforeach; ?>
        ...
        <!-- EXAMS -->
        <li class="<?php if ($page_name == 'marks_manage' || $page_name == 'marks_manage_view' || $page_name == 'question_paper' || $page_name == 'tabulation_shhet') echo 'opened active'; ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'tabulation_sheet') echo 'active'; ?> ">
                    <a href="<?php echo site_url('teacher/tabulation_sheet'); ?>">
        ...
        <!--ass-->
        <li class="<?php if ($page_name == 'manage_assignment') echo 'opened active'; ?> ">
            <a href="#">
                <i class="flaticon-placeholder-2"></i>
            ...
            <ul>
                <li class="<?php if ($page_name == 'add_assignment') echo 'active'; ?> ">
                    <a href="<?php echo site_url($account_type . '/create_assignment'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('create_assignment'); ?></span>
                    </a>
                </li>

                <li class="<?php if ($page_name == 'manage_assignment' ) echo 'active'; ?> ">
                    <a href="<?php echo site_url($account_type . '/manage_assignment'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('manage_assignment'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
