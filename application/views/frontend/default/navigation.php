      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse justify-content-md-center" id="navbarSupportedContent">
          <ul class="navbar-nav ">
            ...
            <li class="nav-item <?php if ($page_name == 'form_details') echo 'active'; ?>">
              <a class="nav-link" href="<?php echo site_url('home/form_details'); ?>">
                <?php echo get_phrase('resume_form_details'); ?>
              </a>
            </li>
