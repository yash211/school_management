			...
			<div class="row justify-content-center" style="border-radius: 50px;">
				<div class="col-md-8">
					<div class="card-group">
						<div class="card p-4">
							<form action="Login_resume/verify" method="post">
								<div class="card-body">
									<h1>LOGIN</h1>
						...
						<div class="card text-white  py-5 d-md-down-none" style="width:44%; background: url('assets/images/cover.jpg') no-repeat;background-size: cover;">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-md-12 mr-auto">
								...
								<form class="form" method="POST" action="Login_resume/registerUser">
									<div class="card-body">
