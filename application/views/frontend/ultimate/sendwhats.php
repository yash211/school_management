                ...
                <div class="tabs-vertical-env">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="b-profile">
                            ...
                            <?php echo form_open(
                                site_url('admin/sms_settings/active_service'),
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="active_sms_service" class="form-control selectboxit">
                                        ...
                                        <option value="clickatell" <?php if ($active_sms_service == 'clickatell') echo 'selected'; ?>>
                                            Clickatell
                                        </option>
                                        <option value="twilio" <?php if ($active_sms_service == 'twilio') echo 'selected'; ?>>
                                            Twilio
                                        </option>
                                        <option value="msg91" <?php if ($active_sms_service == 'msg91') echo 'selected'; ?>>
                                            MSG91
                                        </option>
                        ...
                        <div class="tab-pane" id="v-home">
                            <?php echo form_open(
                                site_url('admin/sms_settings/clickatell'),
                                array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')
                            ); ?>
                            <div class="form-group">
                        ...
                        <div class="tab-pane" id="v-profile">
                            <?php echo form_open(
                                site_url('admin/sms_settings/twilio'),
                                array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')
                            ); ?>
                            <div class="form-group">
                        ...
                        <div class="tab-pane" id="v-msg91-profile">
                            <?php echo form_open(
                                site_url('admin/sms_settings/msg91'),
                                array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')
                            ); ?>
                            <div class="form-group">
